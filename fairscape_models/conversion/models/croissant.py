...
class CroissantDataset(BaseModel):
    ...
    data_manipulation_protocol: Optional[Union[str, List[str]]] = Field(default=None, alias="rai:dataManipulationProtocol")
    ...
    data_release_maintenance_plan: Optional[Union[str, List[str]]] = Field(default=None, alias="rai:dataReleaseMaintenancePlan")
    ...
    data_biases: Optional[Union[str, List[str]]] = Field(default=None, alias="rai:dataBiases")
    data_limitations: Optional[Union[str, List[str]]] = Field(default=None, alias="rai:dataLimitations")
    data_use_cases: Optional[Union[str, List[str]]] = Field(default=None, alias="rai:dataUseCases")
