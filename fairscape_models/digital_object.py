...
class DigitalObject(BaseModel):
    ...
    md5: Optional[Union[str,List[str]]] = Field(default=None, description="MD5 checksum of the digital object content")
    hash: Optional[Union[str,List[str]]] = Field(default=None, description="Hash of the digital object content (if not MD5)")
